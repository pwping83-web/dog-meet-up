...
export const mockMeetups: Meetup[] = [
  {
    ...
    location: '서울 영등포구',
    district: '영등포구',
    images: [MEETUP_LIST_COVER_PHOTOS.largeDog],
  ...
  },
  {
    ...
    location: '서울 강남구',
    district: '강남구',
    images: [MEETUP_LIST_COVER_PHOTOS.walkOutdoor],
  ...
  },
  {
    ...
    location: '서울 서초구',
    district: '서초구',
    images: [MEETUP_LIST_COVER_PHOTOS.socialization],
  ...
  },
  {
    ...
    location: '서울 마포구',
    district: '마포구',
    images: [BREED_STOCK_PHOTO_UNSPLASH.maltese],
  ...
  },
  {
    ...
    location: '서울 송파구',
    district: '송파구',
    images: [MEETUP_LIST_COVER_PHOTOS.indoorCare],
    estimatedCost: '교배 가능',
    listingVisibleUntil: '2030-12-31T00:00:00.000Z',
    status: 'completed',
  ...
  },
  {
    ...
    location: '서울 마포구',
    district: '마포구',
    images: [MEETUP_LIST_COVER_PHOTOS.dachshund],
    estimatedCost: '주말 오후',
    status: 'pending',
  ...
  },
  {
    ...
    location: '경기 안양시',
    district: '안양시 만안구',
    images: [BREED_STOCK_PHOTO_UNSPLASH.poodle],
...
export const mockDogSitters: DogSitter[] = [
  {
    id: 'r1',
    name: '미미맘 🐩',
    profileImage: BREED_STOCK_PHOTO_UNSPLASH.poodle,
    location: '서울 강남구 (역삼동)',
    district: '강남구',
    dong: '역삼동',
  ...
  },
  {
    id: 'r2',
    name: '훈련사 민호 🎓',
    profileImage: BREED_STOCK_PHOTO_UNSPLASH.goldenRetriever,
    location: '서울 서초구',
    district: '서초구',
  ...
  },
  {
    id: 'r3',
    name: '댕시터 하늘 🌤️',
    profileImage: BREED_STOCK_PHOTO_UNSPLASH.maltese,
    location: '서울 강남구',
    district: '강남구',
  ...
  },
  {
    id: 'r7',
    name: '대구댕집사 🐾',
    profileImage: BREED_STOCK_PHOTO_UNSPLASH.pomeranian,
    location: '대구 수성구',
    district: '수성구',
